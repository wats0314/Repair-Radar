...
function fetchData() {
    ...
    fetch(url)
      ...
      .then(data => {
        ...
        // Define b1Value as the value of cell C2
        const b1Value = data.values[1][2];
  
        // Do something with blue1 and b1Value
        console.log(blue1, b1Value);
        updateB1Class(blue1, b1Value);
...
function updateB1Class(blue1, b1Value) {
    const b1Div = document.getElementById('b1');
    const b1ValueElem = document.getElementById('item-b1');
    ...
    b1ValueElem.textContent = b1Value;
  }
